...
#since to date
f_month = int(str(form.getvalue('f_month')))
f_day = int(str(form.getvalue('f_day')))
f_year = int(str(form.getvalue('f_year'))) + 2000

#to date
t_month = int(str(form.getvalue('t_month')))
t_day = int(str(form.getvalue('t_day')))
t_year = int(str(form.getvalue('t_year'))) + 2000
