...
def schedule_last_logon(pattern,starting,ending,l_flag,n_flag,t_flag,s_date,t_date) :
    ...
    print """
    Since Date (YYYYMMDDhhmmss): <input type="text" name="s_date" maxlength = "12"
    """
    print ' value="' + s_date + '"' + " readonly=readonly " +  "><br>"

    print """
    To Date (YYYYMMDDhhmmss): <input type="text" name="t_date" maxlength = "12"
    """
    print ' value="' + t_date + '"' + " readonly=readonly " +  "><br>"
