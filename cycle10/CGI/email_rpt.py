...
def email_last_logon(filename) :
    ...
    send_from = read_ini.read_ini_parameter("LastLogon")['send_from']
    send_to = read_ini.read_ini_parameter("LastLogon")['send_to']
    subject = read_ini.read_ini_parameter("LastLogon")['comment']
    text = read_ini.read_ini_parameter("LastLogon")['text']
