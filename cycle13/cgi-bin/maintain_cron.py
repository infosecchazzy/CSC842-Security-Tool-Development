...
def list_scheduled_reports() :
    ...
    #cron user
    cronu = read_ini.read_ini_parameter("LastLogon")['cronuser']

    #assign the crontab
    cront = CronTab(user=cronu)

    #find the jobs with the comment
    c_comment = read_ini.read_ini_parameter("LastLogon")['comment']
    scheduled_jobs = cront.find_comment(c_comment) 
